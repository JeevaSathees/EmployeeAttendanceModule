    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            <div class="form-section">
                <h2 class="mb-4 text-primary text-center"><asp:Label ID="lblFormTitle" runat="server" Text="Attendance Record"></asp:Label></h2>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:CustomValidator ID="cvTimeOut" runat="server" ControlToValidate="txtTimeOut"
                            ...
                            CssClass="text-danger d-block" Display="Dynamic" />
                    </div>
                </div>
            ...
            <div class="gridview-container mt-4">
                <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False" DataKeyNames="ID"
                    OnRowCommand="gvAttendance_RowCommand" CssClass="table table-bordered table-hover" GridLines="None">
                    <Columns>
